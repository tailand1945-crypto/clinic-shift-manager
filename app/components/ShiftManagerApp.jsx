    ...
    <div style={{ display:"flex", flexDirection:"column", height:"100%" }}>
      ...
      <div style={{ flex:1, overflow:"auto", padding:20, maxWidth:800 }}>
        ...
        {step===3 && (
          <div style={{ textAlign:"center", padding:"48px 0" }}>
            ...
            <p style={{ fontSize:14, color:T.textSub, lineHeight:1.7, margin:0 }}>310件のシフトを登録しました。<br/>シフト表画面で確認してください。</p>
      ...
      {(step===0||step===2) && (
        <div style={{ padding:"12px 20px", background:T.white, borderTop:`1px solid ${T.border}`, display:"flex", gap:10 }}>
          ...
          <Btn variant={step===0?"primary":"success"} onClick={step===0?startGen:()=>setStep(3)} style={{ flex:1 }}>
